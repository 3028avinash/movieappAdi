...
ActiveRecord::Schema[7.0].define(version: 2024_01_15_102120) do
  ...
  create_table "favorite_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["episode_id"], name: "index_favorite_lists_on_episode_id"
    t.index ["user_id", "episode_id"], name: "index_favorite_lists_on_user_id_and_episode_id", unique: true
  ...
  add_foreign_key "favorite_lists", "episodes"
