...
class ContentsTest < ApplicationSystemTestCase
  ...
  test "should create content" do
    ...
    fill_in "Banner", with: @content.banner
    fill_in "Category", with: @content.category
    fill_in "Genre", with: @content.genre
    fill_in "Release date", with: @content.release_date
    check "Status" if @content.status
    fill_in "Title", with: @content.title
    fill_in "Trailer link", with: @content.trailer_link
    fill_in "Views", with: @content.views
    check "Vip status" if @content.vip_status
