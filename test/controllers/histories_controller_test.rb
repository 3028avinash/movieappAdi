...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference("History.count") do
      post histories_url, params: { history: { episode_id: @history.episode_id, favorite_list: @history.favorite_list, user_id: @history.user_id, watch_list: @history.watch_list } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { episode_id: @history.episode_id, favorite_list: @history.favorite_list, user_id: @history.user_id, watch_list: @history.watch_list } }
