...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { content_id: @reminder.content_id, status: @reminder.status, user_id: @reminder.user_id } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { content_id: @reminder.content_id, status: @reminder.status, user_id: @reminder.user_id } }
