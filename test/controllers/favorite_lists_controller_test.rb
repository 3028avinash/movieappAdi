...
class FavoriteListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite_list" do
    assert_difference("FavoriteList.count") do
      post favorite_lists_url, params: { favorite_list: { episode_id: @favorite_list.episode_id, user_id: @favorite_list.user_id } }
    end
  ...
  test "should update favorite_list" do
    patch favorite_list_url(@favorite_list), params: { favorite_list: { episode_id: @favorite_list.episode_id, user_id: @favorite_list.user_id } }
