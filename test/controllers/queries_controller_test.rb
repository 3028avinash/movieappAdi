...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference("Query.count") do
      post queries_url, params: { query: { message: @query.message, query_type: @query.query_type, user_id: @query.user_id } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { message: @query.message, query_type: @query.query_type, user_id: @query.user_id } }
