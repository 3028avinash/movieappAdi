...
class WatchlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watchlist" do
    assert_difference("Watchlist.count") do
      post watchlists_url, params: { watchlist: { episode_id: @watchlist.episode_id, user_id: @watchlist.user_id } }
    end
  ...
  test "should update watchlist" do
    patch watchlist_url(@watchlist), params: { watchlist: { episode_id: @watchlist.episode_id, user_id: @watchlist.user_id } }
